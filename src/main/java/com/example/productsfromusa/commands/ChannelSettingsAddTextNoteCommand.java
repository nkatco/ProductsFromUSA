...
@Component
public class ChannelSettingsAddTextNoteCommand implements Command {
    ...
    public TelegramMessage apply(Update update) {
        ...
        try {
            ...
            try {
                ...
                channelSettings.setPostText(text);

                channelSettingsService.saveChannelSettings(channelSettings);

                message.setText("Дополнительный текст успешно установлен.");
