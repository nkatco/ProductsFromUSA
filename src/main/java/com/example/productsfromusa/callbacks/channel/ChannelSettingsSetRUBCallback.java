...
@Component
public class ChannelSettingsSetRUBCallback implements CallbackHandler {
    ...
    public TelegramMessage apply(Update update) {
        ...
        String id = callbackData.substring(CallbackType.SET_RUB.length());
        Channel channel = channelService.getChannelById(id);

        ChannelSettings channelSettings = channel.getChannelSettings();
        channelSettings.setCourse("RUB");
