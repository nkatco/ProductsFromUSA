...
@Component
public class ChannelSettingsAddOldShowPriceCallback3 implements CallbackHandler {
    ...
    public TelegramMessage apply(Update update) {
        ...
        String id = callbackData.substring(CallbackType.ADD_SHOW_OLD_PRICE3.length());
        ...
        if (channel != null) {
            ...
            if(user.getState().equals(States.SHOW_OLD_PRICE)) {
                ...
                channelSettings.setShowOldPrice(false);
