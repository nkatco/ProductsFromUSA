...
@Component
public class ChannelSettingsRemoveSurchargeCallback implements CallbackHandler {
    ...
    public TelegramMessage apply(Update update) {
        ...
        String id = callbackData.substring(CallbackType.REMOVE_COURSE.length());
        ...
        if (channel != null) {
            ...
            if (user.getState().equals(States.SET_SURCHARGE)) {
                ...
                channelSettings.setAddCourse(1.0);
